$(document).ready(function() {
    ...
    $(sur).focus(function() { if (surOn == 1) { $(this).attr('value', '').css('color', '#686868'); surOn = 0; }; });
    ...
    $(practice).focus(function() { if (practOn == 1) { $(this).attr('value', '').css('color', '#686868'); practOn = 0; }; });
    ...
    $('#register').click(function() {
        ...
        //validation
        if (sur.value == '' || sur.value == 'Surname') {
            $('#surname').css('background-color', '#fac2c2');
        } else {
                ...
                if (add1.value == '' || add1.value == 'Address 1') {
                    ...
                    if (city.value == '' || city.value == 'City') {
                        ...
                        if (postcode.value == '' || postcode.value == 'Post code') {
                            ...
                            PageMethods.sendMail(first.value, sur.value, tel.value, email.value, practice.value, add1.value, add2.value, city.value,
