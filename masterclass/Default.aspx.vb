...
Public Shared Function sendMail(ByVal first As String, ByVal tel As String, ByVal email As String, ByVal add1 As String, ByVal add2 As String, ByVal city As String, ByVal postcode As String, ByVal attentOnline As String, ByVal diet As String, ByVal Date2703 As String, ByVal Date0805 As String, ByVal Date1907 As String, ByVal Date1809 As String)
